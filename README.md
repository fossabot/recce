...
recce/1.8.5 darwin-x64 node-v11.1.0
$ recce --help [COMMAND]
USAGE
  $ recce COMMAND
...
...
_See code: [lib/commands/api-extract.js](https://github.com/escapace/recce/blob/v1.8.5/lib/commands/api-extract.js)_
...
_See code: [lib/commands/build.js](https://github.com/escapace/recce/blob/v1.8.5/lib/commands/build.js)_
