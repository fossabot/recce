...
recce/1.1.1 linux-x64 node-v9.5.0
$ recce --help [COMMAND]
USAGE
  $ recce COMMAND
...
...
_See code: [src/commands/build.ts](https://github.com/escapace/recce/blob/v1.1.1/src/commands/build.ts)_
...
_See code: [src/commands/watch.ts](https://github.com/escapace/recce/blob/v1.1.1/src/commands/watch.ts)_
<!-- commandsstop -->
